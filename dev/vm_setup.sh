...
echo -e "\n5. All (a)\n"
echo -e "\e[1;31mEnter the option: \e[0m"
read OPTION
 
###### DOCKER CONFIGURATION #######
if [ "$OPTION" = "d" ] || [ "$OPTION" = "a" ]; then
...
if [ "$OPTION" = "d" ] || [ "$OPTION" = "a" ] || [ "$OPTION" = "du" ]; then
...
if [ "$OPTION" = "dc" ] || [ "$OPTION" = "a" ]; then
    ...
    echo -e "\n\e[1;31m********* DOCKER-COMPOSE NOT CHOSEN *********\e[0m"
fi

###### KUBECTL CONFIGURATION #######
if [ "$OPTION" = "k" ] || [ "$OPTION" = "a" ]; then
...
if [ "$OPTION" = "dd" ] || [ "$OPTION" = "a" ]; then
    ...
    echo -e "\n\e[1;31m********* DDCLIENT NOT CHOSEN *********\e[0m"
fi
